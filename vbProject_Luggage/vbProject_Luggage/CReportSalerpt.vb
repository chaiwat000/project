...
Public Class CReportSalerpt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "vbProject_Luggage.CReportSalerpt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCReportSalerpt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CReportSalerpt = New CReportSalerpt()
        rpt.Site = Me.Site
        Return rpt
    End Function
